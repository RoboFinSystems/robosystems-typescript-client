 ...
 */
export const changeRepositoryPlan = <ThrowOnError extends boolean = false>(options: Options<ChangeRepositoryPlanData, ThrowOnError>) => (options.client ?? client).patch<ChangeRepositoryPlanResponses, ChangeRepositoryPlanErrors, ThrowOnError>({
    security: [{ name: 'X-API-Key', type: 'apiKey' }, { scheme: 'bearer', type: 'http' }],
    url: '/v1/graphs/{graph_id}/subscriptions',
    ...options,
    headers: {
